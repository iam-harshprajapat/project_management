    ...
    return (
        <>
            ...
            <section className='section5'>
                <h2>Our Projects</h2>
                <p className='para'>We know what buyers are looking for and suggest projects that will bring clients top dollar for the sale of their homes.</p>
            ...
            <section className='section7'>
                ...
                <p className='para'>Stay connected with us for the latest news and updates. Subscribe to our newsletter for regular insights and information.</p>
                <div className='s7-form-box'>
                    <form onSubmit={handleSubscriberSubmit}>
                        <input type='email' placeholder='Enter your email' value={subscriberEmail} onChange={(e) => setSubscriberEmail(e.target.value)} required />
